    ...
    <div className={`min-h-screen ${isDesktop ? 'desktop-bg' : 'mobile-bg'} ${isDesktop ? '' : 'pt-20 pb-20'}`}>
      <div className={`space-y-6 ${isDesktop ? 'max-w-6xl mx-auto p-8' : 'px-4 py-6'}`}>
        ...
        <div className={`flex items-center justify-between ${isDesktop ? 'mb-8' : 'mb-6'}`}>
          ...
          <h2 className={`${isDesktop ? 'text-2xl' : 'text-xl'} font-bold text-white`}>Team History</h2>
              ...
              >
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className={`${isDesktop ? 'text-lg' : 'text-base'} font-bold text-white`}>
                        Level {level.level}
                      </h3>
                  ...
                  {level.members.length > 0 && (
                    <motion.button
                      ...
                      className="flex items-center space-x-2 px-3 py-2 bg-white/10 hover:bg-white/20 rounded-xl text-white transition-all"
                    >
                      {level.isLoading ? (
                        <motion.div
                          animate={{ rotate: 360 }}
                            ...
                            <div className={`flex items-center ${isDesktop ? 'space-x-4' : 'space-x-3'}`}>
                              ...
                              <div className="flex-1 min-w-0">
                                <div className={`flex items-center justify-between ${isDesktop ? 'mb-1' : 'mb-0.5'}`}>
                                  <h4 className={`text-white font-semibold ${isDesktop ? 'text-base' : 'text-sm'} truncate pr-2`}>
                                    {member.name}
                                  </h4>
                                  <div className={`text-white/60 ${isDesktop ? 'text-sm' : 'text-xs'}`}>
                                    Level {member.level}
                                  </div>
                                </div>
